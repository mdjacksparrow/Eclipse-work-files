...
public class NotepadString extends Frame
{
        boolean b=true;
        Frame fm;
         FileDialog fd;
 ...
 class Open implements ActionListener
         {
                  public void actionPerformed(ActionEvent ae)
                  {
                   FileDialog fd=new FileDialog(NotepadString.this,"Select File",FileDialog.LOAD);
                   fd.show();
 ...
 class Save implements ActionListener
          {
                  public void actionPerformed(ActionEvent ae)
                  {
                    FileDialog fd=new FileDialog(NotepadString.this,"Save File",FileDialog.SAVE);
                    fd.setFile(fn);
                    fd.setDirectory(dn);
                    fd.show();
 ...
 class Paste implements ActionListener
         {
          public void actionPerformed(ActionEvent ae)
                  {
                   Transferable cliptran=clip.getContents(NotepadString.this);
                   try{
